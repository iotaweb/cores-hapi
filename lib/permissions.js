...
Permissions.prototype.checkOwnership = function(action, resource, request, doc) {
  
    var userKey = resource.schema._options.additionalProperties.value.userKey; 
    
    if (doc[userKey] === request.auth.credentials.id) {
